                          ...
                          <div className="flex flex-col space-y-6">
                            ...
                            <div className={`p-6 rounded-xl border-l-4 shadow-sm transition-all hover:translate-x-1 ${darkMode
                              ...
                              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">{roomName}</h3>
                                <div className="relative">
                                  <button
                                    onClick={handleShareRoom}
                                    className={`flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg font-bold text-xs md:text-sm transition-all ${
                                      darkMode
                                  ...
                                  {/* Share Dropdown */}
                                  {showShareDropdown && (
                                    <div className={`absolute left-0 md:right-0 md:left-auto top-12 z-50 w-56 rounded-lg shadow-xl border ${
