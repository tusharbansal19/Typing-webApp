            ...
            <>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-transparent text-white border-b-2 py-2 px-4 outline-none ${errors.name ? 'border-red-500' : 'border-white'} focus:border-white text-[1.5rem] py-2 text-blue-700 transition-all duration-300`}
                  required
                />
                <label htmlFor="name" className={`absolute left-4 top-0 transition-all duration-300 text-lg text-white ${name && '-top-4 text-xs'}`}>Name</label>
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <label htmlFor="email" className={`absolute left-4 top-0 transition-all duration-300 text-lg text-white ${email && '-top-4 text-xs'}`}>Email</label>
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <label htmlFor="password" className={`absolute left-4 top-0 transition-all duration-300 text-lg text-white ${password && '-top-4 text-xs'}`}>Password</label>
